...
<html>
    <head>
        ...
        <title>The Church of St-Andrew and St-Paul - Youth Group News</title>
        <style>
            .children-sub {
                display: block;
            }
    	...
    	<div class="wrapper">
    		...
    		<div class="content responsive-padding">
                ...
                <div class="sub-content">
                    <h1>Children / Youth News</h1>
                    <div id="articleContainer">
                        <?php
                            for ($i = count($md5hash) - 1; $i >= 0; $i--) {
                                if($event[$i] == 'Youth,Events' || $event[$i] == 'Youth,News') {
