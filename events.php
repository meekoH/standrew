...
<html>
                    ...
                    <div id="articleContainer">
                        <?php
                            for ($i = count($md5hash) - 1; $i >= 0; $i--) {
                                if($event[$i] == 'Youth,Events' || $event[$i] == 'Church,Events' || $event[$i] == 'Outreach,Events' || $event[$i] == 'Worship,Events' || $events[$i] == 'Music,Events' || $event[$i] == 'Youth,News' || $event[$i] == 'Outreach,News' || $event[$i] == 'Worship,News' || $event[$i] == 'Music,News') {
    ...
    <script>
        ...
        $('#events-responsive').addClass('selected');
        $('#eventsSub').addClass('selected');
    </script>
</html>